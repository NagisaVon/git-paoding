...
The name comes from 庖丁解牛 (_Chef Ding carves the ox_): the butcher who cuts along the natural joints, so the blade never dulls.


## How to use

Install the python package and the agent plugin:
...
Or just give this repository URL to your coding agent and ask it to install
